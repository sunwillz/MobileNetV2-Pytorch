...
parser.add_argument('--width-multi',default=1.,type=float)
parser.add_argument('--expansion','-t',default=6,type=int)
...
parser.add_argument('--train-root', default='images/train', type=str)
parser.add_argument('--train-source', default='train.txt', type=str)
parser.add_argument('--val-root', default='images/val', type=str)
parser.add_argument('--val-source', default='val.txt', type=str)
